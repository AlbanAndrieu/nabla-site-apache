...
test.describe('Homepage Tests', () => {
  ...
  test('should have correct meta tags', async ({ page }) => {
    ...
    await expect(description).toHaveAttribute('content', /DevSecOps/);
    
    // Check meta keywords
    const keywords = page.locator('meta[name="keywords"]');
    await expect(keywords).toHaveAttribute('content', /DevSecOps/);
  ...
  test('should have Open Graph meta tags', async ({ page }) => {
    ...
    await expect(ogTitle).toHaveAttribute('content', /Alban Andrieu/);
    ...
    await expect(ogDescription).toHaveAttribute('content', /DevSecOps/);
  });
