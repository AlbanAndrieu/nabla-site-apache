...
\cventry{Depuis 2022}{Agent IA juridique}{\href{https://www.jusmundi.com}{Jus Mundi}}{Paris}{}{}
{
\textit{https://jusmundi.com}
\bigskip

\textbf{Architecte Cloud} \hfill 2022-2026
	\begin{itemize}%
		\item Transformation vers l'IA
			\begin{itemize}%
				\item Utilisation d'OpenAI avec FastAPI MCP, LangFuse, n8n et LLM Maison pour mieux contrôler la qualité et le coût
				\item Automatisation des processus de sécurité et de conformité dans l'environnement cloud. Compliant ISP 27001 / 42001, SOC2, RGPD
				\item Gestion de l'infrastructure as code avec Ansible, Terraform et ArgoCD
				\item Optimisation des workflows SDLC pour le déploiement efficace et la sécurité en travaillant en étroite collaboration avec les développeurs et les data scientists
				\item Conception et maintenance de l'architecture des systèmes cloud, assurant une haute disponibilité, une scalabilité optimale et une confidentialité maximale pour les avocats
			\end{itemize}
	\end{itemize}
}
\bigskip
\cventry{2007-2022}{Éditeur de logiciel financier}{Finastra}{Paris}{}{}
{
...
\bigskip
	\begin{itemize}%
	\item	Projet d'intégration pour unifier l'environnement de SDLC
		\begin{itemize}%
				\item Définition des processus livraison, ajout de métrique de qualité
				\item Unification de l'infrastructure et du système de SDLC sous Jenkins
...
\bigskip
			\begin{itemize}
				\item Intégration au sein de l'equipe plateforme interne, plateforme back-office interne. Architecture web 3 niveaux centrée autour de services métiers C++ et interfacés par du Java enterprise via middleware.
...
{
	\textit{https://wholesale.banking.societegenerale.com/fr/}

	\bigskip
	\textbf{Ingénieur d'étude}
\bigskip
\begin{itemize}
\item Suivi et amélioration de systèmes d'informations (systemes internes) de gestion des opérations d'achat/vente sur titre dans le cadre d'un Back Office
	\begin{itemize}
