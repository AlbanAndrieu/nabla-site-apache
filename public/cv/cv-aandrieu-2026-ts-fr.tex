...
\begin{twentytimeline}
	...
	\twentyitemtimeline{\faCode}
		...
		{Paris, France}
		{\begin{itemize}
		\item \textbf{Mission :} Modules stock et comptabilité — an internal back-office platform
		\item Architecture 3 tiers : services métier C++, Java enterprise, middleware
	...
	\twentyitemtimeline{\faBriefcase}
		...
		{Paris, France}
		{\begin{itemize}
		\item \textbf{Mission :} Systèmes d'information back-office (internal systems)
