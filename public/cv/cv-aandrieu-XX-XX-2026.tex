	...
	\begin{itemize}%
		\item Transformation vers l'IA
			\begin{itemize}%
				...
				\item Optimisation des workflows CI/CD pour le déploiement efficace et la sécurité en travaillant en étroite collaboration avec les développeurs et les data scientists
