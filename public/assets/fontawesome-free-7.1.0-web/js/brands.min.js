...
(() => {
	...
	var _z = void 0 === (z = c.navigator?.userAgent) ? "" : z;
	function s(c, l) {
	...
	function m(l, c) {
		...
		return (
			Object.getOwnPropertySymbols &&
				...
				c &&
					(z = z.filter(
						(c) => Object.getOwnPropertyDescriptor(l, c).enumerable,
					)),
				s.push.apply(s, z)),
			s
		);
			...
			((c, l) => {
				...
				if (c)
					return "string" === typeof c
						...
						: "Map" ===
									(z =
										"Object" === (z = {}.toString.call(c).slice(8, -1)) &&
										c.constructor
											? c.constructor.name
											: z) || "Set" === z
							? Array.from(c)
	...
	var l = {
						...
						M(
							M(
								M(
									M(
										M(
											M(M((z = {}), f, "Classic"), "duotone", "Duotone"),
											"sharp",
											"Sharp",
										),
										"sharp-duotone",
				...
				M(
					M(
						M(
							M(
								M(
									M(M(z, "notdog-duo", "Notdog Duo"), "slab", "Slab"),
									"slab-press",
									"Slab Press",
								),
								"thumbprint",
				...
				M(
					M(
						M(
							M(
								M(
									M(M(u, "notdog-duo", "Notdog Duo"), "slab", "Slab"),
									"slab-press",
									"Slab Press",
								),
								"thumbprint",
		...
		o = []
			...
			.concat(u.map((c) => "".concat(c, "x")))
			.concat(b.map((c) => "w-".concat(c))),
	...
	function p(c) {
		return new Proxy(c, { get: (c, l) => (l in c ? c[l] : c[f]) });
	}
	...
	var g = l[L];
	function h(s) {
		return Object.keys(s).reduce((c, l) => {
			var z = s[l];
			return z.icon ? (c[z.iconName] = z.icon) : (c[l] = z), c;
		}, {});
	}
	function y(c, l, z) {
		var _s = (2 < arguments.length && void 0 !== z ? z : {}).skipHooks,
			s = void 0 !== s && s,
			M = h(l);
	...
	!((c) => {
		try {
			for (
				var l = arguments.length, z = new Array(1 < l ? l - 1 : 0), s = 1;
				s < l;
				s++
			)
				z[s - 1] = arguments[s];
