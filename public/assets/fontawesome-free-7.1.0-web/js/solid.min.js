...
(() => {
	...
	function e(l) {
		for (var c = 1; c < arguments.length; c++) {
			...
			c % 2
				? M(Object(s), !0).forEach((c) => {
						a(l, c, s[c]);
					})
				: Object.getOwnPropertyDescriptors
					? Object.defineProperties(l, Object.getOwnPropertyDescriptors(s))
					: M(Object(s)).forEach((c) => {
	...
	var l = {
		...
		o = []
			...
			.concat(d.map((c) => "".concat(c, "x")))
			.concat(u.map((c) => "w-".concat(c))),
	...
	function p(c) {
		return new Proxy(c, { get: (c, l) => (l in c ? c[l] : c[r]) });
	}
	...
	function S(c, l, s) {
		var _z = (2 < arguments.length && void 0 !== s ? s : {}).skipHooks,
			z = void 0 !== z && z,
			a = b(l);
