...
((a, l) => {
	...
	function t(l, a) {
		...
		return (
			Object.getOwnPropertySymbols &&
				...
				a &&
					(e = e.filter(
						(a) => Object.getOwnPropertyDescriptor(l, a).enumerable,
					)),
				r.push.apply(r, e)),
			r
		);
			...
			((a, l) => {
				...
				if (a)
					return "string" === typeof a
						...
						: "Map" ===
									(e =
										"Object" === (e = {}.toString.call(a).slice(8, -1)) &&
										a.constructor
											? a.constructor.name
											: e) || "Set" === e
							? Array.from(a)
	...
	var _l = {
						...
						f(
							f(
								f(
									f(
										f(
											f(f((e = {}), s, "Classic"), "duotone", "Duotone"),
											"sharp",
											"Sharp",
										),
										"sharp-duotone",
				...
				f(
					f(
						f(
							f(
								f(
									f(f(e, "notdog-duo", "Notdog Duo"), "slab", "Slab"),
									"slab-press",
									"Slab Press",
								),
								"thumbprint",
				...
				f(
					f(
						f(
							f(
								f(
									f(f(g, "notdog-duo", "Notdog Duo"), "slab", "Slab"),
									"slab-press",
									"Slab Press",
								),
								"thumbprint",
		...
		d = []
			...
			.concat(g.map((a) => "".concat(a, "x")))
			.concat(m.map((a) => "w-".concat(a))),
	...
	function w(a) {
		return new Proxy(a, { get: (a, l) => (l in a ? a[l] : a[s]) });
	}
	(p = o({}, l)),
	...
	return (
		((a) => {
			...
			var a;
			"function" === typeof k.hooks.addShims
				? k.hooks.addShims(q)
				: (a = k.shims).push.apply(a, q);
		}),
		q
	);
});
