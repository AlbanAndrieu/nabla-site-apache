...
(() => {
	...
	var _s = void 0 === (s = c.navigator?.userAgent) ? "" : s;
	function a(c, l) {
	...
	function f(l) {
		for (var c = 1; c < arguments.length; c++) {
			...
			c % 2
				? z(Object(s), !0).forEach((c) => {
						e(l, c, s[c]);
					})
				: Object.getOwnPropertyDescriptors
					? Object.defineProperties(l, Object.getOwnPropertyDescriptors(s))
					: z(Object(s)).forEach((c) => {
						...
						e(
							e(
								e(
									e(
										e(
											e(e((s = {}), t, "Classic"), "duotone", "Duotone"),
											"sharp",
											"Sharp",
										),
										"sharp-duotone",
				...
				e(
					e(
						e(
							e(
								e(
									e(e(s, "notdog-duo", "Notdog Duo"), "slab", "Slab"),
									"slab-press",
									"Slab Press",
								),
								"thumbprint",
				...
				e(
					e(
						e(
							e(
								e(
									e(e(u, "notdog-duo", "Notdog Duo"), "slab", "Slab"),
									"slab-press",
									"Slab Press",
								),
								"thumbprint",
	...
	function b(c) {
		return new Proxy(c, { get: (c, l) => (l in c ? c[l] : c[t]) });
	}
	...
	function y(c, l, s) {
		var _a = (2 < arguments.length && void 0 !== s ? s : {}).skipHooks,
			a = void 0 !== a && a,
			e = p(l);
	...
	!((c) => {
		try {
			for (
				var l = arguments.length, s = new Array(1 < l ? l - 1 : 0), a = 1;
				a < l;
				a++
			)
				s[a - 1] = arguments[a];
