d3 = (() => {
	...
	function L(t, n) {
		...
		return (
			...
			arguments.length
				...
				: ((t = 1), (e = n / 4)),
			(r) => 1 + t * Math.pow(2, 10 * -r) * Math.sin((2 * (r - e) * Ti) / n)
		);
	}
	function F(t) {
	...
	function ne(t) {
		return (n) => (0 > n ? -Math.pow(-n, t) : Math.pow(n, t));
	}
	function ee(t, n) {
		function e(n) {
	...
	function re(t, n) {
		...
		return (
			(r.domain = (n) =>
				arguments.length
					? ((t = n.filter((t) => !isNaN(t)).sort(Ci.ascending)), e())
					: t),
	...
	(Ci.functor = c),
		...
		(Ci.sum = (t, n) => {
			var e,
				...
				i = -1;
			if (1 === arguments.length)
				while (u > ++i) isNaN((e = +t[i])) || (r += e);
			else while (u > ++i) isNaN((e = +n.call(t, t[i], i))) || (r += e);
			return r;
		}),
		(Ci.quantile = (t, n) => {
	...
	var $i = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;
	(Ci.round = (t, n) =>
		n ? Math.round(t * (n = Math.pow(10, n))) / n : Math.round(t)),
		(Ci.xhr = (t, n, e) => {
			function r() {
				var t = l.status;
	...
	(Ci.interpolators = [
		...
		(t, n) => n instanceof Array && Ci.interpolateArray(t, n),
		(t, n) =>
		...
		(t, n) =>
			!isNaN((t = +t)) && !isNaN((n = +n)) && Ci.interpolateNumber(t, n),
	]),
	...
	var La = Ci.format(".0e");
	(Wn.pow = (t) => Math.pow(10, t)),
		(Qn.pow = (t) => -Math.pow(10, -t)),
	...
	Ci.svg.brush = () => {
		...
		return (
			(t.x = (n) =>
				arguments.length ? ((o = n), (l = Ka[(!o << 1) | !c]), t) : o),
			(t.y = (n) =>
				arguments.length ? ((c = n), (l = Ka[(!o << 1) | !c]), t) : c),
			(t.extent = (n) => {
				var e, r, u, a, l;
				return arguments.length
					? ((i = [
