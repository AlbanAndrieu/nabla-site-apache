d3 = (() => {
	...
	function w(t, n) {
		var e = 10 ** (3 * Math.abs(8 - n));
		return { scale: n > 8 ? (t) => t / e : (t) => t * e, symbol: t };
	}
	function S(t) {
		return (n) => (0 >= n ? 0 : n >= 1 ? 1 : t(n));
	}
	function k(t) {
		return (n) => 1 - t(1 - n);
	}
	function E(t) {
		return (n) => 0.5 * (0.5 > n ? t(2 * n) : 2 - t(2 - 2 * n));
	}
	function A(t) {
		return t * t;
	}
	...
	function L(t, n) {
		...
		return (
			...
			arguments.length
				...
				: ((t = 1), (e = n / 4)),
			(r) => 1 + t * 2 ** (10 * -r) * Math.sin((2 * (r - e) * Ti) / n)
		);
	}
	function F(t) {
		return t || (t = 1.70158), (n) => n * n * ((t + 1) * n - t);
	}
	function H(t) {
		return 1 / 2.75 > t
			? 7.5625 * t * t
	...
	function Z(t, n) {
		return (n = n - (t = +t) ? 1 / (n - t) : 0), (e) => (e - t) * n;
	}
	function X(t, n) {
		return (
			(n = n - (t = +t) ? 1 / (n - t) : 0),
			(e) => Math.max(0, Math.min(1, (e - t) * n))
		);
	}
	function B() {}
	function $(t, n, e) {
			...
			switch (((u = r[2].split(",")), r[1])) {
				case "hsl":
					return e(
						...
						Number.parseFloat(u[1]) / 100,
						Number.parseFloat(u[2]) / 100,
					);
				case "rgb":
	...
	function tn(t) {
		return 0.04045 >= (t /= 255) ? t / 12.92 : ((t + 0.055) / 1.055) ** 2.4;
	}
	function nn(t) {
	...
	function pn(t) {
		return t > 0.008856 ? t ** (1 / 3) : 7.787037 * t + 4 / 29;
	}
	function dn(t) {
		return Math.round(
			255 * (0.00304 >= t ? 12.92 * t : 1.055 * t ** (1 / 2.4) - 0.055),
		);
	}
	function mn(t) {
		return Vi(t, ba), t;
	...
	function An(t) {
		return (
			...
			(n, e) => !n - !e || t(n.__data__, e.__data__)
		);
	}
	function Nn(t, n, e) {
		function r() {
	...
	function Fn() {
		...
		var r = Hn() - n;
		r > 24
			? (Number.isFinite(r) && (clearTimeout(Na), (Na = setTimeout(Fn, r))),
				(Aa = 0))
			: ((Aa = 1), za(Fn));
	}
	function Hn() {
	...
	function In(t, n, e, r) {
		...
		return (
			(i.invert = (t) => o(t)),
			(i.domain = (n) => (arguments.length ? ((t = n.map(Number)), u()) : t)),
			(i.range = (t) => (arguments.length ? ((n = t), u()) : n)),
			(i.rangeRound = (t) => i.range(t).interpolate(Ci.interpolateRound)),
			(i.clamp = (t) => (arguments.length ? ((r = t), u()) : r)),
			(i.interpolate = (t) => (arguments.length ? ((e = t), u()) : e)),
			(i.ticks = (n) => Bn(t, n)),
			(i.tickFormat = (n) => $n(t, n)),
			(i.nice = () => (Yn(t, Zn), u())),
			(i.copy = () => In(t, n, e, r)),
			u()
		);
	...
	function Zn(t) {
		return (
			(t = 10 ** (Math.round(Math.log(t) / Math.LN10) - 1)),
			t && {
				floor: (n) => Math.floor(n / t) * t,
				ceil: (n) => Math.ceil(n / t) * t,
			}
		);
	}
	function Xn(t, n) {
		var e = Rn(t),
			r = e[1] - e[0],
			u = 10 ** Math.floor(Math.log(r / n) / Math.LN10),
			i = (n / r) * u;
		return (
	...
	function Kn(t, n) {
		...
		var r = n.pow;
		return (
			(e.invert = (n) => r(t.invert(n))),
			(e.domain = (u) =>
				arguments.length
					? ((n = 0 > u[0] ? Qn : Wn), (r = n.pow), t.domain(u.map(n)), e)
					: t.domain().map(r)),
			(e.nice = () => (t.domain(Yn(t.domain(), Un)), e)),
			(e.ticks = () => {
				var e = Rn(t.domain()),
					u = [];
	...
	function te(t, n) {
		...
		var r = ne(n),
			u = ne(1 / n);
		return (
			(e.invert = (n) => u(t.invert(n))),
			(e.domain = (n) =>
				arguments.length ? (t.domain(n.map(r)), e) : t.domain().map(u)),
			(e.ticks = (t) => Bn(e.domain(), t)),
			(e.tickFormat = (t) => $n(e.domain(), t)),
			(e.nice = () => e.domain(Yn(e.domain(), Zn))),
			(e.exponent = (t) => {
	...
	function ee(t, n) {
		...
		function r(n, e) {
			return Ci.range(t.length).map((t) => n + e * t);
		}
		var u, a, o;
		return (
			(e.domain = (r) => {
	...
	function re(t, n) {
		...
		function r(t) {
			return Number.isNaN((t = +t)) ? 0 / 0 : n[Ci.bisect(u, t)];
		}
		var u;
		return (
			(r.domain = (n) =>
				arguments.length
					? ((t = n.filter((t) => !Number.isNaN(t)).sort(Ci.ascending)), e())
					: t),
			(r.range = (t) => (arguments.length ? ((n = t), e()) : n)),
			(r.quantiles = () => u),
			(r.copy = () => re(t, n)),
			e()
		);
	...
	function ue(t, n, e) {
		...
		return (
			(r.domain = (e) =>
				arguments.length ? ((t = +e[0]), (n = +e[e.length - 1]), u()) : [t, n]),
			(r.range = (t) => (arguments.length ? ((e = t), u()) : e)),
			(r.copy = () => ue(t, n, e)),
			u()
		);
	}
	function ie(t, n) {
		...
		return (
			(e.domain = (n) => (arguments.length ? ((t = n), e) : t)),
			(e.range = (t) => (arguments.length ? ((n = t), e) : n)),
			(e.copy = () => ie(t, n)),
			e
		);
	}
	function ae(t) {
		...
		return (
			(n.invert = n),
			(n.domain = n.range =
				(e) => (arguments.length ? ((t = e.map(n)), n) : t)),
			(n.ticks = (n) => Bn(t, n)),
			(n.tickFormat = (n) => $n(t, n)),
			(n.copy = () => ae(t)),
			n
		);
	}
	...
	function se(t) {
		...
		var e = he,
			...
			l = 0.7;
		return (
			(n.x = (t) => (arguments.length ? ((e = t), n) : e)),
			(n.y = (t) => (arguments.length ? ((r = t), n) : r)),
			(n.defined = (t) => (arguments.length ? ((u = t), n) : u)),
			(n.interpolate = (t) =>
				arguments.length
					? ((a =
							"function" === typeof t ? (i = t) : (i = Ya.get(t) || pe).key),
						n)
					: a),
			(n.tension = (t) => (arguments.length ? ((l = t), n) : l)),
			n
		);
	}
	function he(t) {
	...
	function Le(t) {
		...
		var e = he,
			...
			g = 0.7;
		return (
			(n.x = (t) => (arguments.length ? ((e = r = t), n) : r)),
			(n.x0 = (t) => (arguments.length ? ((e = t), n) : e)),
			(n.x1 = (t) => (arguments.length ? ((r = t), n) : r)),
			(n.y = (t) => (arguments.length ? ((u = i = t), n) : i)),
			(n.y0 = (t) => (arguments.length ? ((u = t), n) : u)),
			(n.y1 = (t) => (arguments.length ? ((i = t), n) : i)),
			(n.defined = (t) => (arguments.length ? ((a = t), n) : a)),
			(n.interpolate = (t) =>
				arguments.length
					? ((f =
							"function" === typeof t ? (l = t) : (l = Ya.get(t) || pe).key),
						(_s = l.reverse || l),
						(_h = l.closed ? "M" : "L"),
						n)
					: f),
			(n.tension = (t) => (arguments.length ? ((g = t), n) : g)),
			n
		);
	}
	function Fe(t) {
	...
	function Ye(t, n) {
		t.attr("transform", (t) => `translate(${n(t)},0)`);
	}
	function Ue(t, n) {
		t.attr("transform", (t) => `translate(0,${n(t)})`);
	}
	function Ie(t, n, e) {
		if (((r = []), e && n.length > 1)) {
			for (
	...
	function gr(t) {
		return Ci.merge(
			t.map((t) => (t.children || []).map((n) => ({ source: t, target: n }))),
		);
	}
	function pr(t, n) {
	...
	function wr(t) {
		return 1 + Ci.max(t, (t) => t.y);
	}
	function Sr(t) {
		return t.reduce((t, n) => t + n.x, 0) / t.length;
	}
	function kr(t) {
		var n = t.children;
		return n?.length ? kr(n[0]) : t;
	}
	function Er(t) {
		var n,
			e = t.children;
	...
	function Nr(t) {
		var n = t.children;
		return n?.length ? n[0] : t._tree.thread;
	}
	function Tr(t) {
		var n,
			e = t.children;
	...
	function Or(t, n) {
		...
		return (
			(e.parse = (t) => {
				var n;
				return e.parseRows(t, (t) =>
					n
						? n(t)
						: ((n = Function(
								"d",
								"return {" +
									t.map((t, n) => `${JSON.stringify(t)}: d[${n}]`).join(",") +
									"}",
							)),
							void 0),
				);
			...
			(e.parseRows = (t, n) => {
				...
				for (
					var r, _u, i = {}, a = {}, c = [], _l = t.length, _f = 0, s = 0;
					(r = e()) !== a;
				) {
			...
			(e.format = (t) => t.map(u).join("\n")),
			e
		);
	}
	function Yr(t, n) {
		Object.hasOwn(oo, t.type) && oo[t.type](t, n);
	}
	function Ur(t, n, e) {
		var r,
			u = -1,
	...
	function Wr(t) {
		...
		return (
			(n.precision = (t) =>
				arguments.length ? ((u = (r = t * t) > 0 && 16), n) : Math.sqrt(r)),
			n
		);
	}
	function Qr(t, n) {
	...
	function yu(t, n) {
		...
		return (
			t.invert &&
				n.invert &&
				(e.invert = (e, r) => (
					(e = n.invert(e, r)), e && t.invert(e[0], e[1])
				)),
			e
		);
	}
	...
	function Hu(t) {
		...
		var u,
			...
			o,
			c,
			l = Wr((t, n) => ((t = u(t, n)), [t[0] * f + o, c - t[1] * f])),
			f = 150,
			s = 480,
			h = 250,
			g = 0,
			...
			M = null;
		return (
			(n.stream = (t) => ju(i, y(l(t)))),
			(n.clipAngle = (t) =>
				arguments.length
					? ((y = null == t ? ((M = t), vo) : vu((M = +t))), n)
					: M),
			(n.scale = (t) => (arguments.length ? ((f = +t), r()) : f)),
			(n.translate = (t) =>
				arguments.length ? ((s = +t[0]), (h = +t[1]), r()) : [s, h]),
			(n.center = (t) =>
				arguments.length
	...
	function Ru(t) {
		return (n, e) => (
			(n += t), [n > Ti ? n - 2 * Ti : -Ti > n ? n + 2 * Ti : n, e]
		);
	}
	function Ou(t) {
		var n = Ru(t);
	...
	function Xu(t, n) {
		var e = {
				list: t
					.map((t, n) => ({ index: n, x: t[0], y: t[1] }))
					.sort((t, n) =>
						t.y < n.y ? -1 : t.y > n.y ? 1 : t.x < n.x ? -1 : t.x > n.x ? 1 : 0,
					),
				bottomSite: null,
			},
			r = {
				...
				left: (t) => t.l,
				leftRegion: (t) =>
					null == t.edge ? e.bottomSite : t.edge.region[t.side],
				rightRegion: (t) =>
					null == t.edge ? e.bottomSite : t.edge.region[To[t.side]],
			},
			u = {
				bisect: (t, n) => {
	...
	function Mi(t, n, e) {
		...
		function a(t, r, i) {
			var a = u(t),
				o = [];
			if (i > 1) while (r > a) e(a) % i || o.push(new Date(+a)), n(a, 1);
			else while (r > a) o.push(new Date(+a)), n(a, 1);
			return o;
		}
		function o(t, n, e) {
			try {
	...
	function xi(t, n, e) {
		...
		return (
			(r.invert = (n) => wi(t.invert(n))),
			(r.domain = (n) =>
				arguments.length ? (t.domain(n), r) : t.domain().map(wi)),
			(r.nice = (t) => r.domain(Yn(r.domain(), () => t))),
			(r.ticks = (e, u) => {
				var i = _i(r.domain());
	...
	(Ci.functor = c),
		...
		(Ci.ascending = (t, n) => (n > t ? -1 : t > n ? 1 : t >= n ? 0 : 0 / 0)),
		(Ci.descending = (t, n) => (t > n ? -1 : n > t ? 1 : n >= t ? 0 : 0 / 0)),
		(Ci.mean = (t, n) => {
			var e,
				r = t.length,
				u = 0,
			...
			if (1 === arguments.length)
				while (r > ++i) f((e = t[i])) && (u += (e - u) / ++a);
			else while (r > ++i) f((e = n.call(t, t[i], i))) && (u += (e - u) / ++a);
			return a ? u : void 0;
		}),
		(Ci.median = (t, n) => (
		...
		(Ci.min = (t, n) => {
			var e,
				...
				i = t.length;
			if (1 === arguments.length) {
				while (i > ++u && (null == (e = t[u]) || e !== e)) e = void 0;
				while (i > ++u) null != (r = t[u]) && e > r && (e = r);
			} else {
				while (i > ++u && (null == (e = n.call(t, t[u], u)) || e !== e))
					e = void 0;
				while (i > ++u) null != (r = n.call(t, t[u], u)) && e > r && (e = r);
			}
			return e;
		}),
		(Ci.max = (t, n) => {
			...
			if (1 === arguments.length) {
				while (i > ++u && (null == (e = t[u]) || e !== e)) e = void 0;
				while (i > ++u) null != (r = t[u]) && r > e && (e = r);
			} else {
				while (i > ++u && (null == (e = n.call(t, t[u], u)) || e !== e))
					e = void 0;
				while (i > ++u) null != (r = n.call(t, t[u], u)) && r > e && (e = r);
			}
			return e;
		}),
		(Ci.extent = (t, n) => {
			var e,
				...
				a = t.length;
			if (1 === arguments.length) {
				while (a > ++i && (null == (e = u = t[i]) || e !== e)) e = u = void 0;
				while (a > ++i)
					null != (r = t[i]) && (e > r && (e = r), r > u && (u = r));
			} else {
				while (a > ++i && (null == (e = u = n.call(t, t[i], i)) || e !== e))
					e = void 0;
				while (a > ++i)
		...
		(Ci.sum = (t, n) => {
			var e,
				...
				i = -1;
			if (1 === arguments.length)
				while (u > ++i) Number.isNaN((e = +t[i])) || (r += e);
			else while (u > ++i) Number.isNaN((e = +n.call(t, t[i], i))) || (r += e);
			return r;
		}),
		(Ci.quantile = (t, n) => {
		...
		(Ci.transpose = (t) => Ci.zip.apply(Ci, t)),
		(Ci.zip = () => {
	...
	(Ci.bisectLeft = Bi.left),
		...
		(Ci.nest = () => {
			...
			function n(t, e) {
				...
				return i && u.sort((t, n) => i(t.key, n.key)), u;
			}
			var e,
				r,
				u = {},
			...
			return (
				(u.map = (n) => t(n, 0)),
				(u.entries = (e) => n(t(e, 0), 0)),
				(u.key = (t) => (a.push(t), u)),
				(u.sortKeys = (t) => ((o[a.length - 1] = t), u)),
				(u.sortValues = (t) => ((e = t), u)),
				(u.rollup = (t) => ((r = t), u)),
				u
			);
		}),
		...
		(Ci.merge = (t) => Array.prototype.concat.apply([], t)),
		(Ci.range = (t, n, e) => {
			if (
				(3 > arguments.length &&
			...
			var r,
				...
				a = -1;
			if (((t *= i), (n *= i), (e *= i), 0 > e))
				while ((r = t + e * ++a) > n) u.push(r / i);
			else while (n > (r = t + e * ++a)) u.push(r / i);
			return u;
		}),
		(Ci.requote = (t) => t.replace($i, "\\$&"));
	var $i = /[\\^$*+?|[\]().{}]/g;
	(Ci.round = (t, n) =>
		n ? Math.round(t * (n = 10 ** n)) / n : Math.round(t)),
		(Ci.xhr = (t, n, e) => {
			function r() {
				var t = l.status;
			...
			return (
				...
				(u.mimeType = (t) =>
					arguments.length ? ((n = null == t ? null : `${t}`), u) : n),
				(u.response = (t) => ((_c = t), u)),
				["get", "post"].forEach((t) => {
					u[t] = () => u.send.apply(u, [t].concat(Ui(arguments)));
				}),
				(u.send = (e, r, i) => {
					if (
						(2 === arguments.length &&
		...
		(Ci.text = () => Ci.xhr.apply(Ci, arguments).response(d)),
		(Ci.json = (t, n) => Ci.xhr(t, "application/json", n).response(m)),
		(Ci.html = (t, n) => Ci.xhr(t, "text/html", n).response(v)),
		(Ci.xml = () => Ci.xhr.apply(Ci, arguments).response(y));
	var Ji = {
	...
	(Ci.ns = {
		...
		qualify: (t) => {
			...
			return (
				...
				Object.hasOwn(Ji, e) ? { space: Ji[e], local: t } : t
			);
		},
	}),
		(Ci.dispatch = () => {
	...
	var Gi =
		...
		Ki = Ci.map({
			b: (t) => t.toString(2),
			c: (t) => String.fromCharCode(t),
			o: (t) => t.toString(8),
			x: (t) => t.toString(16),
			X: (t) => t.toString(16).toUpperCase(),
			g: (t, n) => t.toPrecision(n),
			e: (t, n) => t.toExponential(n),
			f: (t, n) => t.toFixed(n),
			r: (t, n) =>
				(t = Ci.round(t, x(t, n))).toFixed(
	...
	var na = () => a,
		...
		ra = Ci.map({ in: a, out: k, "in-out": E, "out-in": (t) => E(k(t)) });
	(Ci.ease = (t) => {
		var n = t.indexOf("-"),
	...
	(Ci.interpolate = (t, n) => {
		...
		(Ci.interpolateNumber = (t, n) => ((n -= t), (e) => t + n * e)),
		(Ci.interpolateRound = (t, n) => ((n -= t), (e) => Math.round(t + n * e))),
		(Ci.interpolateString = (t, n) => {
			...
			for (
				...
				if (((a = f[r]), a.x === e[0])) {
					...
					a.x = Ci.interpolateNumber(
						Number.parseFloat(e[0]),
						Number.parseFloat(a.x),
					);
			while (i > r)
				(a = f.pop()),
					null == l[a.i + 1]
		...
		(Ci.interpolateHsl = (t, n) => {
			...
			return (
				...
				(t) => `${un(e + i * t, r + a * t, u + o * t)}`
			);
		}),
		(Ci.interpolateLab = (t, n) => {
			...
			var e = t.l,
				...
				a = n.a - r,
				o = n.b - u;
			return (t) => `${sn(e + i * t, r + a * t, u + o * t)}`;
		}),
		(Ci.interpolateHcl = (t, n) => {
			...
			return (
				i > 180 ? (i -= 360) : -180 > i && (i += 360),
				(t) => `${cn(e + i * t, r + a * t, u + o * t)}`
			);
		}),
		(Ci.interpolateArray = (t, n) => {
			var e,
				r = [],
				u = [],
				i = t.length,
	...
	(Ci.interpolators = [
		...
		(t, n) => Array.isArray(n) && Ci.interpolateArray(t, n),
		(t, n) =>
	...
	(ca.brighter = function (t) {
		return (
			(t = 0.7 ** (arguments.length ? t : 1)), en(this.h, this.s, this.l / t)
		);
	}),
		(ca.darker = function (t) {
			return (
				(t = 0.7 ** (arguments.length ? t : 1)), en(this.h, this.s, t * this.l)
			);
		}),
		(ca.rgb = function () {
	...
	var da = (t, n) => n.querySelector(t),
		ma = (t, n) => n.querySelectorAll(t),
	...
	"function" === typeof Sizzle &&
		((da = (t, n) => Sizzle(t, n)[0] || null),
		(ma = (t, n) => Sizzle.uniqueSort(Sizzle(t, n))),
	...
	(Ci.selection = () => xa),
			...
			if (2 > arguments.length) {
				if ("string" === typeof t) {
					var e = this.node(),
						...
						u = -1;
					if ((n = e.classList)) {
						while (r > ++u) if (!n.contains(t[u])) return !1;
					} else
						for (
		...
		(ba.data = function (t, n) {
			...
			if ("function" === typeof t)
				while (o > ++a) e((r = this[a]), t.call(r, r.parentNode.__data__, a));
			else while (o > ++a) e((r = this[a]), t);
			return (l.enter = () => c), (l.exit = () => f), l;
		}),
		(ba.datum = function (t) {
			return arguments.length
	...
	var xa = mn([[Li]]);
	(xa[0].parentNode = va),
		(Ci.select = (t) => ("string" === typeof t ? xa.select(t) : mn([[t]]))),
		(Ci.selectAll = (t) =>
			"string" === typeof t ? xa.selectAll(t) : mn([Ui(t)]));
	var _a = [];
	...
	(Sa.call = ba.call),
		...
		(Sa.node = ba.node),
		(Ci.transition = (t) =>
			arguments.length ? (wa ? t.transition() : t) : xa.transition()),
	...
	(Ci.touches = (t, n) => (
		...
		(Ci.scale = {}),
		(Ci.scale.linear = () => In([0, 1], [0, 1], Ci.interpolate, !1)),
		(Ci.scale.log = () => Kn(Ci.scale.linear(), Wn));
	var La = Ci.format(".0e");
	(Wn.pow = (t) => 10 ** t),
		(Qn.pow = (t) => -(10 ** -t)),
		(Ci.scale.pow = () => te(Ci.scale.linear(), 1)),
		(Ci.scale.sqrt = () => Ci.scale.pow().exponent(0.5)),
		(Ci.scale.ordinal = () => ee([], { t: "range", a: [[]] })),
		(Ci.scale.category10 = () => Ci.scale.ordinal().range(Fa)),
		(Ci.scale.category20 = () => Ci.scale.ordinal().range(Ha)),
		(Ci.scale.category20b = () => Ci.scale.ordinal().range(ja)),
		(Ci.scale.category20c = () => Ci.scale.ordinal().range(Pa));
	var Fa = [
			"#1f77b4",
			"#ff7f0e",
			"#2ca02c",
	...
	(Ci.scale.quantile = () => re([], [])),
		(Ci.scale.quantize = () => ue(0, 1, [0, 1])),
		(Ci.scale.threshold = () => ie([0.5], [0, 1])),
		(Ci.scale.identity = () => ae([0, 1])),
		(Ci.svg = {}),
		(Ci.svg.arc = () => {
			function t() {
			...
			var n = oe,
				...
				u = fe;
			return (
				(t.innerRadius = (e) => (arguments.length ? ((n = c(e)), t) : n)),
				(t.outerRadius = (n) => (arguments.length ? ((e = c(n)), t) : e)),
				(t.startAngle = (n) => (arguments.length ? ((r = c(n)), t) : r)),
				(t.endAngle = (n) => (arguments.length ? ((u = c(n)), t) : u)),
				(t.centroid = function () {
	...
	(Ci.svg.line.radial = () => {
		...
		(Ci.svg.chord = () => {
			...
			var o = n,
				...
				h = fe;
			return (
				(e.radius = (t) => (arguments.length ? ((f = c(t)), e) : f)),
				(e.source = (t) => (arguments.length ? ((o = c(t)), e) : o)),
				(e.target = (t) => (arguments.length ? ((l = c(t)), e) : l)),
				(e.startAngle = (t) => (arguments.length ? ((s = c(t)), e) : s)),
				(e.endAngle = (t) => (arguments.length ? ((h = c(t)), e) : h)),
				e
			);
		}),
		(Ci.svg.diagonal = () => {
			...
			var r = n,
				...
				i = He;
			return (
				(e.source = (t) => (arguments.length ? ((r = c(t)), e) : r)),
				(e.target = (t) => (arguments.length ? ((u = c(t)), e) : u)),
				(e.projection = (t) => (arguments.length ? ((i = t), e) : i)),
				e
			);
		}),
		(Ci.svg.diagonal.radial = () => {
			var t = Ci.svg.diagonal(),
				n = He,
				e = t.projection;
			return (t.projection = (t) => (arguments.length ? e(je((n = t))) : n)), t;
		}),
		(Ci.svg.symbol = () => {
			function t(t, r) {
			...
			var n = Re,
				e = Pe;
			return (
				(t.type = (e) => (arguments.length ? ((n = c(e)), t) : n)),
				(t.size = (n) => (arguments.length ? ((e = c(n)), t) : e)),
				t
			);
		});
	var Za = Ci.map({
	...
	Ci.svg.axis = () => {
		...
		var n,
			...
			f = 0;
		return (
			(t.scale = (n) => (arguments.length ? ((e = n), t) : e)),
			(t.orient = (n) =>
				arguments.length ? ((r = n in Ja ? `${n}` : $a), t) : r),
			(t.ticks = () => (arguments.length ? ((c = arguments), t) : c)),
			(t.tickValues = (n) => (arguments.length ? ((l = n), t) : l)),
			(t.tickFormat = (e) => (arguments.length ? ((n = e), t) : n)),
			(t.tickSize = (n, e) => {
			...
			(t.tickPadding = (n) => (arguments.length ? ((o = +n), t) : o)),
			(t.tickSubdivide = (n) => (arguments.length ? ((f = +n), t) : f)),
			t
		);
	};
	var $a = "bottom",
	...
	Ci.svg.brush = () => {
		...
		function n(t) {
			t.selectAll(".resize").attr(
				"transform",
				(t) => `translate(${f[+/e$/.test(t)][0]},${f[+/^s/.test(t)][1]})`,
			);
		}
		function e(t) {
		...
		return (
			(t.x = (n) =>
				arguments.length ? ((o = n), (_l = Ka[(!o << 1) | !c]), t) : o),
			(t.y = (n) =>
				arguments.length ? ((c = n), (_l = Ka[(!o << 1) | !c]), t) : c),
			(t.extent = (n) => {
				var e, r, u, a, l;
				return arguments.length
					? ((i = [
			...
			(t.clear = () => (
				(i = null), (f[0][0] = f[0][1] = f[1][0] = f[1][1] = 0), t
			)),
			(t.empty = () =>
				(o && f[0][0] === f[1][0]) || (c && f[0][1] === f[1][1])),
			Ci.rebind(t, a, "on")
		);
	};
	var Ga = {
		...
		(Ci.behavior.drag = () => {
			...
			function _n() {
				function t() {
					var t = o.parentNode;
					return null != f
						? Ci.touches(t).filter((t) => t.identifier === f)[0]
						: Ci.mouse(t);
				}
				function n() {
				...
				r
					? ((a = r.apply(this, arguments)), (a = [a.x - s[0], a.y - s[1]]))
					: (a = [0, 0]),
					null == f && j(),
					c({ type: "dragstart" });
			}
			var e = R(t, "drag", "dragstart", "dragend"),
				r = null;
			return (
				(t.origin = (n) => (arguments.length ? ((r = n), t) : r)),
				Ci.rebind(t, e, "on")
			);
		}),
		(Ci.behavior.zoom = () => {
			...
			function o() {
				...
				var _o = w.of(this, arguments),
					_c = Ci.event.target,
					_l = 0,
					_f = Ci.select(Fi).on("mousemove.zoom", t).on("mouseup.zoom", e),
					_s = n(Ci.mouse(this));
				Fi.focus(), j();
			}
			function _c() {
			...
			function _f() {
				...
				r(2 ** (Ci.event.shiftKey ? Math.ceil(i) - 1 : Math.floor(i) + 1)),
					u(t, e),
					a(w.of(this, arguments));
			}
			function _s() {
			...
			return (
				(t.translate = (n) =>
					arguments.length ? ((b = n.map(Number)), i(), t) : b),
				(t.scale = (n) => (arguments.length ? ((x = +n), i(), t) : x)),
				(t.scaleExtent = (n) =>
					arguments.length ? ((_ = null == n ? Qa : n.map(Number)), t) : _),
				(t.x = (n) =>
					arguments.length
						? ((m = n), (_d = n.copy()), (b = [0, 0]), (x = 1), t)
						: m),
				(t.y = (n) =>
					arguments.length
						? ((y = n), (_v = n.copy()), (b = [0, 0]), (x = 1), t)
						: y),
				Ci.rebind(t, w, "on")
			);
		});
	var Wa,
		...
		to =
			"onwheel" in document
				? ((Wa = () => -Ci.event.deltaY * (Ci.event.deltaMode ? 120 : 1)),
					"wheel")
				: "onmousewheel" in document
					? ((Wa = () => Ci.event.wheelDelta), "mousewheel")
					: ((Wa = () => -Ci.event.detail), "MozMousePixelScroll");
	(Ci.layout = {}),
		(Ci.layout.bundle = () => (t) => {
		...
		(Ci.layout.chord = () => {
			function t() {
				...
				for (
					a && m.sort((t, n) => a(d[t], d[n])),
						o &&
							v.forEach((t, n) => {
								t.sort((t, e) => o(u[n][t], u[n][e]));
							}),
						t = (2 * Ti - f * i) / t,
						l = 0,
						h = -1;
			...
			return (
				(l.matrix = (t) =>
					arguments.length
						...
						: u),
				(l.padding = (t) =>
					arguments.length ? ((f = t), (e = r = null), l) : f),
				(l.sortGroups = (t) =>
					arguments.length ? ((a = t), (e = r = null), l) : a),
				(l.sortSubgroups = (t) =>
					arguments.length ? ((o = t), (e = null), l) : o),
				(l.sortChords = (t) => (arguments.length ? ((c = t), e && n(), l) : c)),
				(l.chords = () => (e || t(), e)),
				(l.groups = () => (r || t(), r)),
				l
			);
		...
		(Ci.layout.force = () => {
			...
			return (
				...
				(c.nodes = (t) => (arguments.length ? ((v = t), c) : v)),
				(c.links = (t) => (arguments.length ? ((y = t), c) : y)),
				(c.size = (t) => (arguments.length ? ((f = t), c) : f)),
				(c.linkDistance = (t) =>
					arguments.length ? ((h = "function" === typeof t ? t : +t), c) : h),
				(c.distance = c.linkDistance),
				(c.linkStrength = (t) =>
					arguments.length ? ((g = "function" === typeof t ? t : +t), c) : g),
				(c.friction = (t) => (arguments.length ? ((s = +t), c) : s)),
				(c.charge = (t) =>
					arguments.length ? ((p = "function" === typeof t ? t : +t), c) : p),
				(c.gravity = (t) => (arguments.length ? ((d = +t), c) : d)),
				(c.theta = (t) => (arguments.length ? ((m = +t), c) : m)),
				(c.alpha = (t) =>
					arguments.length
						? ((t = +t),
							r
				...
				(c.start = function () {
					function t(t, r) {
						for (var u, i = n(e), a = -1, o = i.length; o > ++a; )
							if (!Number.isNaN((u = i[a][t]))) return u;
					...
					for (e = 0; s > e; ++e)
						(l = v[e]),
							Number.isNaN(l.x) && (l.x = t("x", m)),
							Number.isNaN(l.y) && (l.y = t("y", M)),
							Number.isNaN(l.px) && (l.px = l.x),
							Number.isNaN(l.py) && (l.py = l.y);
	...
	(Ci.layout.partition = () => {
		...
		var r = Ci.layout.hierarchy(),
			u = [1, 1];
		return (e.size = (t) => (arguments.length ? ((u = t), e) : u)), lr(e, r);
	}),
		(Ci.layout.pie = () => {
			function t(i) {
				var a = i.map((e, r) => +n.call(t, e, r)),
					...
					l = Ci.range(i.length);
				null != e &&
					l.sort(e === ro ? (t, n) => a[n] - a[t] : (t, n) => e(i[t], i[n]));
				var f = [];
				return (
					l.forEach((t) => {
						var n;
			...
			var n = Number,
				...
				u = 2 * Ti;
			return (
				(t.value = (e) => (arguments.length ? ((n = e), t) : n)),
				(t.sort = (n) => (arguments.length ? ((e = n), t) : e)),
				(t.startAngle = (n) => (arguments.length ? ((r = n), t) : r)),
				(t.endAngle = (n) => (arguments.length ? ((u = n), t) : u)),
				t
			);
		});
	var ro = {};
	Ci.layout.stack = () => {
		function t(a, c) {
			var l = a.map((e, r) => n.call(t, e, r)),
				f = l.map((n) => n.map((n, e) => [i.call(t, n, e), o.call(t, n, e)])),
				s = e.call(t, f, c);
		...
		var n = a,
			...
			o = Qe;
		return (
			(t.values = (e) => (arguments.length ? ((n = e), t) : n)),
			(t.order = (n) =>
				arguments.length
			...
			(t.offset = (n) =>
				arguments.length
					...
					: r),
			(t.x = (n) => (arguments.length ? ((i = n), t) : i)),
			(t.y = (n) => (arguments.length ? ((o = n), t) : o)),
			(t.out = (n) => (arguments.length ? ((u = n), t) : u)),
			t
		);
	};
	var uo = Ci.map({
			...
			reverse: (t) => Ci.range(t.length).reverse(),
			default: nr,
		}),
		io = Ci.map({
			silhouette: (t) => {
	...
	(Ci.layout.histogram = () => {
		...
		var n = !0,
			...
			u = ar;
		return (
			(t.value = (n) => (arguments.length ? ((e = n), t) : e)),
			(t.range = (n) => (arguments.length ? ((r = c(n)), t) : r)),
			(t.bins = (n) =>
				arguments.length
					? ((u = "number" === typeof n ? (t) => or(t, n) : c(n)), t)
					: u),
			(t.frequency = (e) => (arguments.length ? ((n = !!e), t) : n)),
			t
		);
	}),
		(Ci.layout.hierarchy = () => {
			...
			var r = hr,
				...
				i = sr;
			return (
				(e.sort = (t) => (arguments.length ? ((r = t), e) : r)),
				(e.children = (t) => (arguments.length ? ((u = t), e) : u)),
				(e.value = (t) => (arguments.length ? ((i = t), e) : i)),
				(e.revalue = (t) => (n(t, 0), t)),
				e
			);
		}),
		(Ci.layout.pack = () => {
			...
			var n = Ci.layout.hierarchy().sort(pr),
				...
				r = [1, 1];
			return (
				(t.size = (n) => (arguments.length ? ((r = n), t) : r)),
				(t.padding = (n) => (arguments.length ? ((e = +n), t) : e)),
				lr(t, n)
			);
		}),
		(Ci.layout.cluster = () => {
			...
			var n = Ci.layout.hierarchy().sort(null).value(null),
				...
				r = [1, 1];
			return (
				(t.separation = (n) => (arguments.length ? ((e = n), t) : e)),
				(t.size = (n) => (arguments.length ? ((r = n), t) : r)),
				lr(t, n)
			);
		}),
		...
		(Ci.layout.treemap = () => {
			...
			var a,
				...
				p = 0.5 * (1 + Math.sqrt(5));
			return (
				(i.size = (t) => (arguments.length ? ((l = t), i) : l)),
				(i.padding = (t) => {
					function n(n) {
				...
				(i.round = (t) =>
					arguments.length ? ((c = t ? Math.round : Number), i) : c !== Number),
				(i.sticky = (t) => (arguments.length ? ((h = t), (a = null), i) : h)),
				(i.ratio = (t) => (arguments.length ? ((p = t), i) : p)),
				(i.mode = (t) => (arguments.length ? ((g = `${t}`), i) : g)),
				lr(i, o)
			);
		}),
		(Ci.csv = Or(",", "text/csv")),
		...
		(Ci.geo = {}),
		(Ci.geo.stream = (t, n) => {
			Object.hasOwn(ao, t.type) ? ao[t.type](t, n) : Yr(t, n);
		});
	var ao = {
			Feature: (t, n) => {
				Yr(t.geometry, n);
	...
	(Ci.geo.azimuthalEqualArea = () => Fu(co)).raw = co;
	var lo = Uu((t) => {
		var n = Math.acos(t);
		return n && n / Math.sin(n);
	}, a);
	((Ci.geo.azimuthalEquidistant = () => Fu(lo)).raw = lo),
		(Ci.geo.bounds = tu(a)),
		(Ci.geo.centroid = (t) => {
	...
	Ci.geo.circle = () => {
		...
		return (
			(t.origin = (n) => (arguments.length ? ((r = n), t) : r)),
			(t.angle = (r) =>
				arguments.length ? ((e = iu((n = +r) * zi, u * zi)), t) : n),
			(t.precision = (r) =>
				arguments.length ? ((e = iu(n * zi, (u = +r) * zi)), t) : u),
			t.angle(90)
		);
	};
	var vo = ou(o, pu, mu);
	(Ci.geo.equirectangular = () => Fu(Mu).scale(250 / Ti)).raw = Mu.invert = Mu;
	var yo = Uu((t) => 1 / t, Math.atan);
	((Ci.geo.gnomonic = () => Fu(yo)).raw = yo),
		(Ci.geo.graticule = () => {
			function t() {
			...
			return (
				(t.lines = () =>
					n().map((t) => ({ type: "LineString", coordinates: t }))),
				(t.outline = () => ({
					type: "Polygon",
					coordinates: [
						a(r).concat(
				...
				(t.step = (n) =>
					arguments.length ? ((c = +n[0]), (l = +n[1]), t) : [c, l]),
				(t.precision = (n) =>
					arguments.length
		...
		(Ci.geo.interpolate = (t, n) =>
			wu(t[0] * zi, t[1] * zi, n[0] * zi, n[1] * zi)),
		(Ci.geo.greatArc = () => {
			function e() {
				for (
				...
				(e.target = (t) =>
					arguments.length
						? ((o = t),
							...
							e)
						: o),
				(e.precision = (t) => (arguments.length ? ((c = t * zi), e) : c / zi)),
				e
			);
		}),
		(Su.invert = (t, n) => [
			2 * Ti * t,
			2 * Math.atan(Math.exp(2 * Ti * n)) - Ti / 2,
		]),
		((Ci.geo.mercator = () => Fu(Su).scale(500)).raw = Su);
	var Mo = Uu(() => 1, Math.asin);
	((Ci.geo.orthographic = () => Fu(Mo)).raw = Mo),
		(Ci.geo.path = () => {
			function t(t) {
				return (
					t &&
			...
			var n,
				...
				i = 4.5;
			return (
				(t.area = (t) => ((bo = 0), Ci.geo.stream(t, r(_o)), bo)),
				(t.centroid = (t) => (
					(fo = ho = go = po = 0),
				...
				(t.bounds = (t) => tu(r)(t)),
				(t.projection = (e) =>
					arguments.length ? ((r = (n = e) ? e.stream || Eu(e) : a), t) : n),
				(t.context = (n) =>
					arguments.length
						? ((u = null == (e = n) ? new Au() : new Nu(n)), t)
						: e),
				(t.pointRadius = (n) =>
					arguments.length ? ((i = "function" === typeof n ? n : +n), t) : i),
	...
	Ci.geo.area = (t) => ((So = 0), Ci.geo.stream(t, Ao), So);
	var So,
		ko,
		Eo,
		Ao = {
	...
	((Ci.geo.stereographic = () => Fu(No)).raw = No),
		(Ci.geom = {}),
		(Ci.geom.hull = (t) => {
			...
			for (f = p.length; h > e; ++e)
				if (-1 !== g[e].index) {
					while (!Iu(p[f - 2], p[f - 1], g[e].index, t)) --f;
					p[f++] = g[e].index;
				}
			var m = [];
		...
		(Ci.geom.voronoi = (t) => {
			...
			return (
				...
				(n = n.map((n, e) => {
					var r = t[e][0],
						u = t[e][1],
						i = n.map((t) => Math.atan2(t[0] - r, t[1] - u)),
						a = Ci.range(n.length).sort((t, n) => i[t] - i[n]);
					return a
						.filter((t, n) => !n || i[t] - i[a[n - 1]] > qi)
						.map((t) => n[t]);
				})),
				n.forEach((n, r) => {
					var u = n.length;
	...
	(Ci.geom.delaunay = (t) => {
		...
		(Ci.geom.quadtree = (t, n, e, r, u) => {
			function i(t, n, e, r, u, i) {
				if (!Number.isNaN(n.x) && !Number.isNaN(n.y))
					if (t.leaf) {
						var o = t.point;
						o
	...
	var Oo = Ku(Ho),
		...
		Bo = {
			...
			B: (t) => Po[t.getMonth()],
			c: Ci.time.format(Do),
			d: (t, n) => Qu(t.getDate(), n, 2),
			e: (t, n) => Qu(t.getDate(), n, 2),
			H: (t, n) => Qu(t.getHours(), n, 2),
			I: (t, n) => Qu(t.getHours() % 12 || 12, n, 2),
			j: (t, n) => Qu(1 + Ci.time.dayOfYear(t), n, 3),
			L: (t, n) => Qu(t.getMilliseconds(), n, 3),
			m: (t, n) => Qu(t.getMonth() + 1, n, 2),
			M: (t, n) => Qu(t.getMinutes(), n, 2),
			p: (t) => (t.getHours() >= 12 ? "PM" : "AM"),
			S: (t, n) => Qu(t.getSeconds(), n, 2),
			U: (t, n) => Qu(Ci.time.sundayOfYear(t), n, 2),
			w: (t) => t.getDay(),
			W: (t, n) => Qu(Ci.time.mondayOfYear(t), n, 2),
			x: Ci.time.format(Lo),
			X: Ci.time.format(Fo),
			y: (t, n) => Qu(t.getFullYear() % 100, n, 2),
			Y: (t, n) => Qu(t.getFullYear() % 1e4, n, 4),
			Z: vi,
			"%": () => "%",
		},
		$o = {
	...
	(Ci.time.format.iso =
		...
		Co.forEach((t, n) => {
			...
			var e = (Ci.time[t] = Mi(
				(t) => (
					(t = Ci.time.day(t)).setDate(t.getDate() - ((t.getDay() + n) % 7)), t
				),
				(t, n) => {
		...
		(Ci.time.month = Mi(
			(t) => ((t = Ci.time.day(t)), t.setDate(1), t),
			(t, n) => {
		...
		(Ci.time.year = Mi(
			(t) => ((t = Ci.time.day(t)), t.setMonth(0, 1), t),
			(t, n) => {
	...
	var Wo = [
		...
		tc = [
			[Ci.time.format("%Y"), o],
			[Ci.time.format("%B"), (t) => t.getMonth()],
			[Ci.time.format("%b %d"), (t) => 1 !== t.getDate()],
			[Ci.time.format("%a %d"), (t) => t.getDay() && 1 !== t.getDate()],
			[Ci.time.format("%I %p"), (t) => t.getHours()],
			[Ci.time.format("%I:%M"), (t) => t.getMinutes()],
			[Ci.time.format(":%S"), (t) => t.getSeconds()],
			[Ci.time.format(".%L"), (t) => t.getMilliseconds()],
		],
		nc = Ci.scale.linear(),
		ec = Si(tc);
	(Qo.year = (t, n) => nc.domain(t.map(Ei)).ticks(n).map(ki)),
		(Ci.time.scale = () => xi(Ci.scale.linear(), Qo, ec));
	var rc = Qo.map((t) => [t[0].utc, t[1]]),
		uc = [
			[Ci.time.format.utc("%Y"), o],
			[Ci.time.format.utc("%B"), (t) => t.getUTCMonth()],
			[Ci.time.format.utc("%b %d"), (t) => 1 !== t.getUTCDate()],
			[
				Ci.time.format.utc("%a %d"),
				(t) => t.getUTCDay() && 1 !== t.getUTCDate(),
			],
			[Ci.time.format.utc("%I %p"), (t) => t.getUTCHours()],
			[Ci.time.format.utc("%I:%M"), (t) => t.getUTCMinutes()],
			[Ci.time.format.utc(":%S"), (t) => t.getUTCSeconds()],
			[Ci.time.format.utc(".%L"), (t) => t.getUTCMilliseconds()],
		],
		ic = Si(uc);
	return (
		(rc.year = (t, n) => nc.domain(t.map(Ni)).ticks(n).map(Ai)),
		(Ci.time.scale.utc = () => xi(Ci.scale.linear(), rc, ic)),
		Ci
	);
})();
